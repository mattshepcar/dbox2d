...
public:
	...
	/// @warning This function is locked during callbacks.
	b2Fixture CreateFixture(b2Shape shape, float32 density)
	{
		b2FixtureDef def;
		def.shape = shape;
		def.density = density;
	...
	void GetMassData(ref b2MassData data) const
	{
		data.mass = m_mass;
	...
	void ResetMassData()
	{
		...
		assert(m_type == b2BodyType.b2_dynamicBody);
...
package:
	...
	package this(const b2BodyDef bd, b2World world)
	{
	...
	b2Vec2 m_force = {0.0f, 0.0f};
	float32 m_torque = 0.0f;

	b2World m_world;
	package b2Body m_prev;
	package b2Body m_next;

	package b2Fixture m_fixtureList;
	package int32 m_fixtureCount = 0;

	package b2JointEdge* m_jointList;
	package b2ContactEdge* m_contactList;
