...
module box2d.collision.shapes.b2EdgeShape;
...
public:
	...
	/// Implement b2Shape.
	override b2EdgeShape Clone() const
	{
		return new b2EdgeShape(this);
	}
	...
	b2EdgeShapeDef m_def;
	alias m_def this;
}

struct b2EdgeShapeDef
{
	static const m_radius = b2_polygonRadius;
	...
	b2Vec2 m_vertex0 = {0.0f, 0.0f};
	b2Vec2 m_vertex3 = {0.0f, 0.0f};
	bool m_hasVertex0 = false;
	bool m_hasVertex3 = false;
}
