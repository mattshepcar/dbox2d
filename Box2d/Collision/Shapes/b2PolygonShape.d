...
module box2d.collision.shapes.b2PolygonShape;
...
public:
	...
	this(const b2PolygonShape other)
	{
		this();
	...
	/// Implement b2Shape.
	override b2PolygonShape Clone() const
	{
		return new b2PolygonShape(this); 
	}
	...
	void Set(const b2Vec2[] points)
	{
		...
		m_centroid = ComputeCentroid(m_vertices[0..m]);
	}
...
b2Vec2 ComputeCentroid(const b2Vec2[] vs)
{
	...
	foreach(i, p2; vs)
	{
		// Triangle vertices.
		b2Vec2 p1 = pRef;
		b2Vec2 p3 = i + 1 < vs.length ? vs[i+1] : vs[0];
