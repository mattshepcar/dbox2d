...
module box2d.collision.b2CollidePolygon;
...
private float32 b2EdgeSeparation(const b2PolygonShape poly1, const b2Transform xf1, int32 edge1,
...
private float32 b2FindMaxSeparation(ref int32 edgeIndex,
...
private void b2FindIncidentEdge(ref b2ClipVertex[2] c,
							 ...
							 const b2PolygonShape poly2, const b2Transform xf2)
{
	...
	c[0].id.cf.typeA = b2ContactFeature.Type.e_face;
	c[0].id.cf.typeB = b2ContactFeature.Type.e_vertex;

	c[1].v = b2Mul(xf2, vertices2[i2]);
	c[1].id.cf.indexA = cast(uint8)edge1;
	c[1].id.cf.indexB = cast(uint8)i2;
	c[1].id.cf.typeA = b2ContactFeature.Type.e_face;
	c[1].id.cf.typeB = b2ContactFeature.Type.e_vertex;
}
...
void b2CollidePolygons(ref b2Manifold manifold,
					  b2PolygonShape polyA, const b2Transform xfA,
					  b2PolygonShape polyB, const b2Transform xfB)
{
