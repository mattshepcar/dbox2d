...
module box2d.testbed.tests.pinball;
import box2d.all;
...
public:
	this()
	{
		...
		// Flippers
		{
			...
			m_leftJoint = cast(b2RevoluteJoint)m_world.CreateJoint(jd);
			...
			m_rightJoint = cast(b2RevoluteJoint)m_world.CreateJoint(jd);
		}
	...
	override void KeyboardUp(ubyte key)
	{
		switch (key)
		{
		case 'a':
