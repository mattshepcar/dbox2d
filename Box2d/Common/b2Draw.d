...
struct b2Color
{
	static b2Color opCall(float32 r, float32 g, float32 b)
	{
		b2Color c = {r, g, b};
		return c;
	}
...
public:
	...
	abstract void DrawPolygon(const b2Vec2[] vertices, b2Color color);

	/// Draw a solid closed polygon provided in CCW order.
	abstract void DrawSolidPolygon(const b2Vec2[] vertices, b2Color color);
